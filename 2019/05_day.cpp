...
namespace aoc
{
    ...
    {
    public:
        using output_iterator = std::list<int>::const_iterator;
    ...
    public:
        ...
        auto output_begin () const -> output_iterator
        {
            return stdout_.begin();
        }

        auto output_end () const -> output_iterator
        {
            return stdout_.end();
        }
    ...
    auto print_output (const machine_t& machine)
    {
        auto it  {machine.output_begin()};
        auto end {machine.output_end()};
